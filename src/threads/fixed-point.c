...
void test_fixed_point(void) {
    ...
    /* Test 25: custom */
    printf("\nTest 25: custom (0.57 / (2*0.57 + 1))\n");
    int64_t numer = div_fixed_int(int_to_fixed_p(57),100);  
    int64_t denom = add_fixed_int(div_fixed_int(int_to_fixed_p(57),50),1);
    printf("Result = %d", round_fixed(div_fixed_fixed( mult_fixed_int(numer, 100), denom)));
